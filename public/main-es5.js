...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(authServer, formBuilder) {
    ...
    HeaderComponent.prototype.createLoginForm = function () {
    ...
    HeaderComponent.prototype.createRegisterForm = function () {
    ...
    HeaderComponent.prototype.onLoginSubmit = function () {
        ...
        this.authServer.login(this.loginForm.value).then(function () {
            _this.currentUser = _this.authServer.getCurrentUser();
        }).catch(function (err) {
            console.log('Error', err);
        });
    };
    HeaderComponent.prototype.onRegisterSubmit = function () {
    };
    Object.defineProperty(HeaderComponent.prototype, "registerControls", {
        get: function () {
    ...
    Object.defineProperty(HeaderComponent.prototype, "loginControls", {
        get: function () {
...
var AuthenticationService = /** @class */ (function () {
    ...
    AuthenticationService.prototype.makeAuthApiCall = function (urlPath, user) {
        var url = _environments_environment_prod__WEBPACK_IMPORTED_MODULE_4__["environment"].apiBaseUrl + urlPath;
        return this.http
            .post(url, user)
            .toPromise()
    ...
    AuthenticationService.prototype.login = function (user) {
        var _this = this;
        return this.makeAuthApiCall('login', user).then(function (authRes) {
            _this.saveToken(authRes.token);
        });
    };
    AuthenticationService.prototype.register = function (user) {
        var _this = this;
        return this.makeAuthApiCall('register', user).then(function (authRes) {
            _this.saveToken(authRes.token);
        });
    };
