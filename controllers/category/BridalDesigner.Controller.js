...
exports.update = (req, res) => {
    // role = req.type;
    userId = req.body._id;
    BridalDesigner.findById(userId, function (err, car) {
        ...
        if (req.body.bridalLehengas)
            car.brideWearStartingPrice.bridalLehengas = req.body.bridalLehengas;
        if (req.body.lightLehengas)
            car.brideWearStartingPrice.lightLehengas = req.body.lightLehengas;
        if (req.body.gowns)
            car.brideWearStartingPrice.gowns = req.body.gowns;
        if (req.body.trousseauSarees)
            car.brideWearStartingPrice.trousseauSarees = req.body.trousseauSarees;
        if (req.body.trousseauAnarkalis)
            car.brideWearStartingPrice.trousseauAnarkalis = req.body.trousseauAnarkalis;
        if (req.body.indoWestern)
            car.brideWearStartingPrice.indoWestern = req.body.indoWestern;
        if (req.body.christianWeddingGowns)
            car.brideWearStartingPrice.christianWeddingGowns = req.body.christianWeddingGowns;
        if (req.body.sherwani)
            car.groomWearStartingPrice.sherwani = req.body.sherwani;
        if (req.body.weddingSuitsTuxes)
            car.groomWearStartingPrice.weddingSuitsTuxes = req.body.weddingSuitsTuxes;
        if (req.body.kurtaPyjama)
            car.groomWearStartingPrice.kurtaPyjama = req.body.kurtaPyjama;
        if (req.body.bandhgala)
            car.groomWearStartingPrice.bandhgala = req.body.bandhgala;
        if (req.body.waistCoatsNehruJackets)
            car.groomWearStartingPrice.waistCoatsNehruJackets = req.body.waistCoatsNehruJackets;
        if (req.body.pagadi)
            car.groomWearStartingPrice.pagadi = req.body.pagadi;
        if (req.body.indoWesternGroom)
            car.groomWearStartingPrice.paindoWesterngadi = req.body.indoWesternGroom;
        if (req.body.brideWear == 'true')
            car.youRentFor.brideWear = true;
        else
            car.youRentFor.brideWear = false;
        if (req.body.groomWear == 'true')
            car.youRentFor.groomWear = true;
        else
            car.youRentFor.groomWear = false;
